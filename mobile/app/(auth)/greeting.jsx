  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.body}>
        ...
        <Text style={styles.sectionLabel}>NICE TO MEET YOU</Text>
        <Text style={styles.title}>
          {'Hi, '}
          <Text style={styles.italic}>{firstName ? `${firstName}.` : 'there.'}</Text>
        </Text>
        <Text style={styles.subtitle}>Let's build your trip.</Text>
        <Text style={styles.bodyText}>
          We'll ask you a few quick questions to shape your recommendations — no account dashboards
          or settings to wade through.
        </Text>
      ...
      <View style={styles.bottom}>
        <TouchableOpacity
          style={styles.inkBtn}
          activeOpacity={0.88}
          onPress={() => router.replace('/quiz/start')}
        >
          <Text style={styles.inkBtnLabel}>Let's go</Text>
...
const styles = StyleSheet.create({
  ...
  avatarIcon: { color: '#FFFFFF', fontSize: 36, fontWeight: '700' },
  sageDot: {
    position: 'absolute',
    bottom: 4,
    right: -2,
